...
If there is one thing to take from all the recent talk around [#indiepocalypse](https://medium.com/steam-spy/on-indiepocalypse-what-is-really-killing-indie-games-3da3c3a1ea76) (Which is not much) it's that the base quality bar is being raised in all aspects of development, and if you fail in even a couple of areas the risk of total failure starts to get worrying.  It's important to understand that it doesn't matter what the size of your project is nor what genre it fits within - In my experience having someone who can professionally write clean and exciting text is as just an important pillar as art, marketing or design.
...
For inspiration, you can view the full component breakdown of our game here: [Subt Games Writer Scope.pdf](/assets/blog/important-tips-on-hiring-a-video-games-writer/Subt-Games-Writer-Scope.pdf)
...
*"We need a writer! When do we want it? NOW!"*
